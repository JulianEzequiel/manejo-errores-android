...
public class GenericErrorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = fragmentActivity.getLayoutInflater().inflate(R.layout.generic_error_dialog, null);

        ((TextView) view.findViewById(R.id.error_message_text)).setText(fragmentActivity.getText(this.messageResource));
